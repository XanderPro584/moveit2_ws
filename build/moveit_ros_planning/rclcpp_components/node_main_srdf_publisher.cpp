...
#define NODE_MAIN_LOGGER_NAME "srdf_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsrdf_publisher_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<moveit_ros_planning::SrdfPublisher>";
