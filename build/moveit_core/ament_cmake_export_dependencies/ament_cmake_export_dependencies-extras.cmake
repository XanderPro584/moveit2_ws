...
set(_exported_dependencies "angles;Bullet;common_interfaces;eigen_stl_containers;Eigen3;eigen3_cmake_module;fcl;generate_parameter_library;geometric_shapes;geometry_msgs;kdl_parser;moveit_msgs;OCTOMAP;octomap_msgs;osqp;pluginlib;random_numbers;rclcpp;rsl;ruckig;sensor_msgs;shape_msgs;srdfdom;std_msgs;tf2_eigen;tf2_geometry_msgs;tf2_kdl;trajectory_msgs;urdf;urdfdom;urdfdom_headers;visualization_msgs")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to moveit_core_DEFINITIONS, moveit_core_INCLUDE_DIRS,
# moveit_core_LIBRARIES, and moveit_core_LINK_FLAGS.
# Additionally collect the direct dependency names in
# moveit_core_DEPENDENCIES as well as the recursive dependency names
# in moveit_core_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(moveit_core_DEPENDENCIES ${_exported_dependencies})
  set(moveit_core_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(moveit_core_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(moveit_core_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(moveit_core_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(moveit_core_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(moveit_core_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND moveit_core_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
